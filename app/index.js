...
import { View, Text, TouchableOpacity, Animated, Image, ImageBackground, Dimensions, StyleSheet } from 'react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.fullScreenWrapper, { transform: [{ translateX }] }]}>
        <ImageBackground
          source={require('../assets/Students.jpg')} // Replace with your background image
